...
var _txInputFormatter = function (options){
    ...
    if (options.to) {
      options.humanReadable = utils.isHumanReadableString(options.to.toLowerCase())
...
var inputTransactionFormatter = function (options) {
    ...
    // If 'feePayer' exist in transaction, it means it doesn't need 'from' field.
    if (options.feePayer) {
...
var inputAddressFormatter = function (address) {
    ...
    throw new Error(
      `Provided address "${address}" is invalid, the capitalization checksum test failed, if you want to create an human-readable address, please keep a human-readble string rule /^[a-zA-Z][0-9a-zA-Z]{4,12}.klaytn$/`
    );
};
